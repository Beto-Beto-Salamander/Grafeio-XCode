...
class EditSupplier: ObservableObject {
    
    var didChange = PassthroughSubject<EditSupplier, Never>()
    ...
    func editSupplier(fname : String ,
                      lname : String,
                      city_id : String,
                      owner : String,
                      pnumber : String,
        ...
        self.request = Alamofire.request("http://localhost/PPTA/index.php/Supplier/" + supid , method: .put, parameters: parameters)
