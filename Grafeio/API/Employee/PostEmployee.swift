...
class PostEmployee: ObservableObject {
    
    var didChange = PassthroughSubject<PostEmployee, Never>()
    ...
    func postEmployee(fname : String ,
                      lname : String,
                      city_id : String,
                      bdate : String,
                      pnumber : String,
        ...
        self.request = Alamofire.request("http://localhost/PPTA/index.php/EMPLOYEE" , method: .post, parameters: parameters)
